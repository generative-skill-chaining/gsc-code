...
from generative_skill_chaining import envs, networks
from generative_skill_chaining.utils import configs, tensors
...
class Encoder:
    ...
    def decode(
        ...
        **kwargs
        ...
        return self.network.reverse(latent, policy_args, **kwargs)

    def unnormalize(self, observation: torch.Tensor) -> torch.Tensor:
        return self.network.unnormalize(observation)
